/**
 * Mapping ISO 3166-1 numeric codes (used by world-atlas TopoJSON) to alpha-2 codes.
 * world-atlas countries-110m.json uses `id` = numeric code, our logs use alpha-2 (US, ZA, etc).
 */
export const ISO_NUMERIC_TO_ALPHA2: Record<string, string> = {
  ...
  "076": "BR", "084": "BZ", "086": "IO", "090": "SB", "096": "BN", "100": "BG", "104": "MM", "108": "BI",
  "112": "BY", "116": "KH", "120": "CM", "124": "CA", "132": "CV", "136": "KY", "140": "CF", "144": "LK",
  "148": "TD", "152": "CL", "156": "CN", "158": "TW", "170": "CO", "174": "KM", "175": "YT", "178": "CG",
  "180": "CD", "188": "CR", "191": "HR", "192": "CU", "196": "CY", "203": "CZ", "204": "BJ", "208": "DK",
  "212": "DM", "214": "DO", "218": "EC", "222": "SV", "226": "GQ", "231": "ET", "232": "ER", "233": "EE",
  "234": "FO", "238": "FK", "239": "GS", "242": "FJ", "246": "FI", "248": "AX", "250": "FR", "254": "GF",
...
// Helper: get alpha-2 from world-atlas geography id (numeric string)
export function numericIdToAlpha2(id: string | number | null | undefined): string | null {
